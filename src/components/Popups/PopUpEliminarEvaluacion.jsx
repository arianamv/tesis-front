...
import { eliminarEvaluacion, eliminarPlaga } from '../../services/adminService';

function PopUpEliminarEvaluacion({show, setShow, row}) {
    ...
    const handleEliminar = async() => {
      ...
      console.log(row)
      const result = await eliminarEvaluacion(data);
...
export default PopUpEliminarEvaluacion