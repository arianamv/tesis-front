...
function PopUpModificarEvalEval({fechaInicio, state, show, setShow, row}) {
    ...
    React.useEffect(() => {
      const selectedEvaluador = evaluadores.filter((entry) => entry.idUsuario === state.usuario.idUsuario);
...
export default PopUpModificarEvalEval